...
function multiplyArray(testArray){ //eslint-disable-line
  ...
  var message = 'The numbers ' + testArray + ' have a product of ' + multTotal + '.';

  return [multTotal, message];
}
